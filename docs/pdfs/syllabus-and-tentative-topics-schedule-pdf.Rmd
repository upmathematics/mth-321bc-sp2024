...
Given the following assignment grade, the student's work is able to:
...
You can cancel your scheduled help hours, exams (oral part), or make-ups/retakes, but it is strongly recommended that you cancel 12 hours before your scheduled time so that other students can schedule when a spot opens. You can reschedule for a different day and time if you need to.

Please try to show-up to any of your scheduled appointments. If you have extenuating circumstances, please let me know as soon as possible to discuss next steps.
