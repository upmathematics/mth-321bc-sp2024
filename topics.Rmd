...
|  | Th 2/15 | **Exam 1** | - | - | - |
| **6** | Tu 2/20 | Systems of 1st-Order ODEs & <br>Modeling Physical Processes | TBA | - | TBA |
|  | Th 2/22 | _Cancelled_ | TBA | Assigned: Homework 3 | TBA |
| **7** | Tu 2/27 | Analyzing Equilibriums to 1st-Order Linear and Non-Linear Systems, & <br> Linear Transformations | TBA | - | TBA |
|  | Th 2/29 | Eigentheory & <br> Stability Analysis of 1st-Order Linear Systems | TBA | Assigned: Homework 4 | TBA |
...
|  | Th 3/14 | Laplace Transforms for Solving 1st-Order Linear Systems | TBA | - | TBA |
| **10** | Tu 3/19 | _Review_ | Exam 2 Examples | - | Exam 2 Topics |
|  | Th 3/21 | **Exam 2** | - | - | - |
| **11** | Tu 3/26 | Higher Order ODEs & <br>Modeling Physical Processes | TBA | - | TBA |
